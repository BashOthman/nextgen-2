...
const rmqlog_service_1 = require("./rmqlog.service");
let AppController = class AppController {
    rmqLoggerService;
    constructor(rmqLoggerService) {
        this.rmqLoggerService = rmqLoggerService;
    }
    async getLogs(queue) {
        if (!queue) {
...
exports.AppController = AppController = __decorate([
    ...
    __metadata("design:paramtypes", [rmqlog_service_1.RmqLoggerService])
], AppController);
